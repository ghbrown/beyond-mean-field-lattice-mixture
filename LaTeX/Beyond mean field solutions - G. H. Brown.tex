...
Restricting to finite periodic lattice of $N$ total sites with $N_A$ $A$ sites and $N_B$ $B$ sites (uniquely defining a volume fraction $\nu = N_B / N$), one can further define the $m_{XY}$s.
...
Relevant solution stuff on Molecular Driving Forces page 271
