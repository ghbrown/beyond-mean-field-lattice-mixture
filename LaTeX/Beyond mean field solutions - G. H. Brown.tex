...
\end{align}
where the sum runs over all possible microstates of the macrostate, and $k_B$ is the Boltzmann constant ($8.617 \times 10^{-5}$ eV K$^{-1}$ here)
...
Table \ref{param_ranges} lists the possible ranges for each of the parameters.
...
\begin{tabular}{c | l | l | l} 
    ...
    $x$ & $\mathbb{R} \in [0.0,1.0)$ & linear & not applicable \\ \hline
...
include vertices of parameter hypercube, then take random samples from middle
